        ...
        <>
            <div className="fixed top-0 left-0 right-0 z-40 flex h-14 items-center justify-between bg-stone-950/90 px-4 text-white backdrop-blur md:hidden">
                ...
                <div className="flex items-center gap-5">
                    <a href="https://www.linkedin.com/.com" aria-label="LinkedIn" className="text-gray-400 hover:text-sky-500">
                                ...
                                {abas.map((aba) => {
                                    ...
                                    return (
                                        <li key={aba.href}>
                                            <a
                                                href={aba.href}
                                                className={`block rounded-lg px-3 py-2 text-center text-lg transition-colors ${ativo ? "font-bold text-white" : "font-normal text-gray-500 hover:text-white"
                                                    }`}
                                            >
                                                {aba.label}
                                            </a>
